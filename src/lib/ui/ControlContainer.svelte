<script lang="ts" generics="S extends ZFormObject">
  ...
  import type { ZFormObject, ZFormPaths, ZDotPaths, BaseFormClientState } from '$lib/form/types.js';
  type Props = {
    schema: S;
    path: ZFormPaths<S>;
    form: BaseFormClientState<S>;
    children: Snippet<[id: string, name: string, error: string | undefined, touched: boolean]>;
    class?: string;
  } ;
