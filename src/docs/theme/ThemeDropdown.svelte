...
<button class="btn btn-outline btn-accent" popovertarget="popover-1" style="anchor-name:--anchor-1">
  {@render themeIcon(themeService.mode)}
  <span class="sr-only">Set Theme</span>
</button>
<ul role="menu" class="dropdown dropdown-end menu w-36 rounded-box bg-base-100 shadow-lg translate-y-2"
  popover id="popover-1" style="position-anchor:--anchor-1">
  <li role="presentation" class="menu-title dark:text-gray-300"><span>Set Theme</span></li>
